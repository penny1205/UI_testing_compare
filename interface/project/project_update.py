...
class ProjectUpdate(object):
    ...
    def __init__(self):
        ...
        self.__selectProjectApiUrl = "https://{0}:{1}{2}/api/tms/customer/updateProject".format(
    ...
    def project_create(self,projectId='',updateType='',projectName='',custId='',startTime ='',endTime=''):
         '''修改项目'''
         try:
             payload ={
                 'projectId':projectId,
