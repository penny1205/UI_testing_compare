...
class ProjectCreate(object):
   ...
   /api/tms/customer/addProject
    ...
    def __init__(self):
        ...
        self.__projectCreateApiUrl = "https://{0}:{1}{2}/api/tms/customer/addProject".format(
    ...
    def project_create(self,projectName='',custId='',startTime ='',endTime=''):
         ...
         try:
             ...
             response = HttpClient().post_json(self.__projectCreateApiUrl,payload,self.__head_dict)
             return response
         except Exception:
             return None