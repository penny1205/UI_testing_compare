...
class TestWayBill(unittest.TestCase):
    ...
    @parameterized.expand([
        ('2','2017-09-14','ShiDeTang','TMS','北京','北京','天津','天津','1000','10','0.01','0.02','0.03','0.04','1'
         ,'备注我要录单测试','快递','10','10','10','10','10'),
    ])
    def test_waybill_success(self,carType,applyDate,partnerNo,source,sendProvince,sendCity,arriveProvince,arriveCity,
        ...
        waybillCreated,mobile = CreateWayBill().create_waybill(carType,applyDate,partnerNo,source,
                                                               sendProvince,sendCity,arriveProvince,arriveCity,
                                                               income,totalAmt,preAmt,oilAmt,destAmt,lastAmt,hasReceipt,
                                 content,cargoName,cargoWeight,cargoVolume,cargoNumberOfCases,cargoWorth,insuranceCosts)
        waybill_list = WayBillSelect().waybill_select(normalCondition=mobile,searchStatus=True)['content']['dataList']
